...
var site3Card = require("./site3Card")(
  config.stripeKey,
  config.herokuKey,
  config.herokuUrl
);
...
kb_magstripe.on("error", (message) =>
  console.log("kb_magstripe Error: ", message)
);
kb_magstripe
  .open(config.magstripe, false)
